...
public class MediaMuxerWrapper {
	...
	public void startRecording() {
		...
		dbHelper.setField(Table.STORY, String.valueOf(blockID), Story.FILE_URL.getName(), mOutputPath);
	}
...
//**********************************************************************
	...
	*/
	...
	private final String createDirectory(){
		String storyID
				= dbHelper.getColumn(Table.STORY, Story.STORIES_ID.getName(),
				Story.ID.getName(), String.valueOf(blockID))[0];
		String storyName
				= dbHelper.getColumn(Table.STORIES, Stories.NAME.getName(),
				Stories.ID.getName(), String.valueOf(storyID))[0];
